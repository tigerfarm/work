...
Use the <a href="Client.html#document">Client#document</a> method to obtain a reference to a Sync Document.
...
<hr>
<dt>
    <h4 class="name" id="set"><span class="type-signature">&lt;async&gt; </span>set(data [, metadataUpdates])</h4>
...
<span class="param-type">Promise.&lt;Object&gt;</span>
    ...
    <pre class="sunlight-highlight-javascript">// Say, the Document data is { name: &apos;John Smith&apos;, age: 34 }
...
<span class="param-type">Promise.&lt;Object&gt;</span>
    ...
    <pre class="sunlight-highlight-javascript">// Say, the Document data is { name: &apos;John Smith&apos; }
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The current data of the document in the cloud.</td>
        </tr>
...
<div class="param-desc">
    The desired new data for the document or <code>null</code> to gracefully cancel the mutation.
</div>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">Contains a snapshot of the document data before removal.</td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">Contains a snapshot of the document data before the update.</td>
        </tr>
