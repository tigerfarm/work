...
echo "+++ Take Conference participant off hold using the conference name: " . $FriendlyName . ", and CallSid: " . $CallSid . "\xA";
...
$participant = $twilio->conferences($conferences[0]->sid)
                      ...
                      ->update(array("hold" => False)
                      );
print('+ Taken off hold: Participant SID: ' . $participant->callSid . "\xA");
